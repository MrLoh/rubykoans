...
class AboutSymbols < Neo::Koan
  ...
  #
  # A symbol gets created, if it is instantiated so `Symbol.all_symbols.include?(:any_symbol)`
  ...
  #
  # Symbols live in the memory until the exit of the program and are never
  # garbage collected, so if you create many of them, they will fill up your
  # memory very fast.
end
