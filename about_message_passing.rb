...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # For some classes a `send` message is already defined or you might
    # want to define it. In these classes you can still use `__send__`.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # If we redefine `method_missing` we can handle what happens if a method
    # is not defined manually. This could be useful to use regular expression
    # matching for method names and define methods dynamically.
    #
    # NOTE:
    #
