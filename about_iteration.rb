...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject performs the operation given in the block on it's argument
    # with each element of the array and returns the value of the modified
    # argument.
    #
    # def inject(a)
    #   self.each{|i| a = yield(a,i)}
    #   return a
    # end
  end
  ...
  #
  # Using `open` directly with a block, ensures that the file is closed
  # even if the block fails. If we assign the file to a variable, we need
  # sandwich code to close the file manually after the operation.
