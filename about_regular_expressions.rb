...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # Only if it is part of a sequence like `abz[/ab*c/]`.
  end
  ...
  #
  # They always math the first instance they find, not the most matching one.
  ...
  #
  # A character class matches letters, alternations can also match strings
